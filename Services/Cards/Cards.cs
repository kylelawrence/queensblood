...
public static class Cards
{
    ...
    private static readonly Func<Card>[] cards = [
        ...
        () => new("Grenadier", 2, 1,
                    ...
                    played: new(Effect.Enfeeble, TargetType.Enemy, 4),
        ...
        () => new("Toxirat", 2, 2,
                    [new(1, 0), new(1, 1)],
                    [new(1,1)],
                    played: new(Effect.Enfeeble, TargetType.Both, 3),
        ...
        () => new("Mu", 2, 1,
                    [new(-1, 1), new(0, 1)],
                    [new(1, 0)],
                    played: new(Effect.Enhance, TargetType.Ally, 1),
                    destroyed: new(Effect.Enfeeble, TargetType.Ally, 1),
                    description: "Raise the power of allied cards on affected tiles by 1 while this card is in play."),
        () => new("Mandragora", 1, 1,
                    [new(0, 1), new(1, 0)],
                    played: new(Effect.AddCard, TargetType.Self, (int)CardAdds.MandragoraMinion),
        ...
        () => new("Cactuar", 1, 1,
                    [new(0, 1), new(1, 0)],
                    [new(2, 1)],
                    played: new(Effect.Enhance, TargetType.Ally, 3),
                    destroyed: new(Effect.Enfeeble, TargetType.Ally, 3),
        ...
        () => new("Crystalline Crab", 1, 1,
                    ...
                    [new(-1, 0)],
                    played: new(Effect.Enhance, TargetType.Ally, 2),
                    destroyed: new(Effect.Enfeeble, TargetType.Ally, 2),
        ...
        () => new("Capparwire", 1, 3,
                    [new(-1, 0), new(0, 1), new(1, 0)],
                    [new(-1, 0), new(1, 0)],
                    played: new(Effect.Enfeeble, TargetType.Both, 1),
        ...
        () => new("Mindflayer", 2, 1,
                    ...
                    [new(-1, 0), new(-1, 1), new(1, 0), new(1, 1)],
                    played: new(Effect.Enfeeble, TargetType.Both, 1),
                    destroyed: new(Effect.Enhance, TargetType.Both, 1),
                    description: "Lower the power of allied and enemy cards on affected tiles by 1 while this card is in play."),
        () => new("Scrutineye", 1, 1,
                    [new(-2, 0), new(2, 0)],
                    [new(-1, 0), new(1, 0)],
                    played: new(Effect.Enhance, TargetType.Both, 1),
                    destroyed: new(Effect.Enfeeble, TargetType.Both, 1),
        ...
        () => new("Flametrooper", 1, 3,
                    ...
                    [new(-1, -1), new(0, -1), new(1, -1)],
                    destroyed: new(Effect.Enfeeble, TargetType.Both, 3),
                    description: "When played, lower the power of allied and enemy cards on affected tiles by 3."),
        () => new("Spearhawk", 1, 1,
        ...
        () => new("Sea Devil", 3, 1,
                    [new(-1, 0), new(0, -1), new(0, 1)],
                    cardPlayed: new(Effect.Enhance, TargetType.Self, 1, ValueType.Power, TargetType.Ally),
                    description: "When played, raise the power of allied cards on affected tiles by 1."),
        () => new("Shoalopod", 2, 1,
                    [new(-1, 0), new(-1, 1), new(0, 1)],
                    [new(-1, 0)],
                    played: new(Effect.Enhance, TargetType.Ally, 4),
                    destroyed: new(Effect.Enfeeble, TargetType.Ally, 4),
                    description: "Raise the power of allied cards on affected tiles by 4 while this card is in play."),
        () => new("Crown Lance", 2, 2,
                    [new(1, 0), new(1, 1), new(2, 1)],
                    [new(1, 1), new(2, 1)],
                    played: new(Effect.Enfeeble, TargetType.Both, 2),
                    description: "When played, lower the power of allied and enemy cards on affected tiles by 2."),
        () => new("Tonberry King", 2, 1,
                    [new(0, 1)],
                    cardDestroyed: new(Effect.Enhance, TargetType.Self, 2, ValueType.Power, TargetType.Ally),
                    description: "When allied cards are destroyed, raise this card's power by 2."),
        () => new("Sandhog Pie", 1, 1,
                    [new(-1, 0), new(0, 1)],
                    [new(-1, 0), new(0, 1)],
                    destroyed: new(Effect.Enhance, TargetType.Ally, 3),
                    description: "When destroyed, raise the power of allied cards on affected tiles by 3."),
        () => new("Bloatfloat", 1, 1,
                    [new(0, 1), new(1, 0)],
                    [new(0, 2)],
                    destroyed: new(Effect.Enfeeble, TargetType.Both, 4),
                    description: "When destroyed, lower the power of allied and enemy cards on affected tiles by 4."),
        () => new("Bagnadrana", 3, 2,
                    [new(0, 1), new(1, 1)],
                    cardPlayed: new(Effect.Enhance, TargetType.Self, 1, ValueType.Power, TargetType.Enemy),
                    description: "When enemy cards are played from hand, raise this card's power by 1."),
        () => new("Cockatrice", 2, 3,
                    [new(0, 1)],
                    [new(0, 1)],
                    played: new(Effect.Destroy, TargetType.Both),
                    description: "When played, destroy allied and enemy cards on affected tiles."),
        () => new("Heatseeker", 1, 1,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    destroyed: new(Effect.AddCard, TargetType.Self, (int)CardAdds.HeatseekerMinion),
        ...
        () => new("Death Claw", 1, 2,
                    [new(-1, 0), new(0, 1)],
                    cardDestroyed: new(Effect.Enhance, TargetType.Self, 1, ValueType.Power, TargetType.Enemy),
                    description: "When enemy cards are destroyed, raise this card's power by 1."),
        () => new("Landworm", 3, 5,
                    [new(0, 1), new(1, 0), new(1, 1)],
                    cardDestroyed: new(Effect.Enhance, TargetType.Self, 2, ValueType.Power, TargetType.Enemy),
        ...
        () => new("Sandspitter", 2, 3,
                    ...
                    played: new(Effect.Enfeeble, TargetType.Both, 1),
                    description: "When played, lower the power of allied and enemy cards on affected tiles by 1.",
                    imageOffsets: new(-10, -15)),
        () => new("Chimera", 2, 4,
                    [new(-1, 0), new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 2, ValueType.EachEnemyEnfeebled),
                    description: "Raise power by 2 for each enfeebled enemy card."),
        () => new("Joker", 2, 2,
                    [new(-2, 0), new(-2, 1), new(2, 0), new(2, 1)],
                    cardDestroyed: new(Effect.Enhance, TargetType.Self, 1, ValueType.Power, TargetType.Both),
                    description: "When allied and enemy cards are destroyed, raise this card's power by 1."),
        () => new("Amphidex", 1, 2,
                    [new(-2, 0), new(0, 1)],
                    [new(-2, 0), new(-1, 0)],
                    enhanced: new(Effect.Enhance, TargetType.Ally, 3),
        ...
        () => new("Insectoid Chimera", -1, 2,
                    ...
                    imageOffsets: new(-10, -10)),
        () => new("Gigantoad", -1, 3,
                    [new(-1, 0), new(0, 1)],
                    description: "Destroy an allied card and replace it."),
        () => new("Maloceros", 3, 5,
                    [new(-2, 1), new(0, -1), new(0, 1), new(2, 1)],
                    laneWon: new(Effect.AddScore, TargetType.Self, 10),
        ...
        () => new("Great Malboro", 3, 3,
                    [new(-1, 1), new(0, 1), new(1, 1)],
                    [new(-1, 1), new(0, 1), new(1, 1)],
                    played: new(Effect.Enfeeble, TargetType.Both, 6),
        ...
        () => new("Grangalan", 3, 3,
                    ...
                    played: new(Effect.AddCard, TargetType.Self, (int)CardAdds.GrangalanJunior),
                    description: "When played, add Grangalan Junior to your hand."),
        () => new("Amalgam", 1, 1,
                    [new(0, -1), new(0, 1)],
                    destroyed: new(Effect.AddCard, TargetType.Self, (int)CardAdds.ResurrectedAmalgam),
                    description: "When destroyed, add Resurrected Amalgam to your hand."),
        () => new("Skeeskee", 1, 1,
                    [new(-1, 0), new(0, -1), new(0, 1)],
                    cardDestroyed: new(Effect.Enhance, TargetType.Self, 1, ValueType.Power, TargetType.Ally),
                    description: "When allied cards are destroyed, raise this card's power by 1."),
        () => new("Griffon", -1, 1,
                    [new(-1, 0), new(0, 1)],
                    [new(-1, 1)],
                    played: new(Effect.Enhance, TargetType.Ally, 0, ValueType.ReplacedPower),
                    description: "Replace and ally and raise the power of allied cards on affected tiles by the replaced ally's power."),
        () => new("Basilisk", 3, 2,
                    [new(-1, 1), new(1, -1), new(1, 1)],
                    [new(1, 1)],
                    played: new(Effect.Destroy, TargetType.Enemy),
                    description: "When played, destroy enemy cards on affected tiles."),
        () => new("Reapertail", 1, 3,
                    [new(-1, 0), new(0, 1)],
                    [new(-2, 1), new(-1, 1)],
                    enfeebled: new(Effect.Enfeeble, TargetType.Enemy, 2),
        ...
        () => new("Desert Sahagin", 1, 3,
                    [new(0, 1), new(1, 0)],
                    [new(1, 0)],
                    enfeebled: new(Effect.Enhance, TargetType.Ally, 4),
        ...
        () => new("Stone Golem", 1, 4,
                    ...
                    enhanced: new(Effect.Enfeeble, TargetType.Enemy, 4),
                    description: "When first enhanced, lower the power of enemy cards on affected tiles by 4."),
        () => new("Two Face", 2, 3,
                    [new(-1, 0), new(1, 0)],
                    [new(-1, 0), new(1, 0)],
                    enhanced: new(Effect.Enhance, TargetType.Ally, 4),
                    enfeebled: new(Effect.Enfeeble, TargetType.Ally, 4),
        ...
        () => new("Gi Specter", -1, 2,
                    [new(1, 0), new(1, 1)],
                    [new(1, 1)],
                    played: new(Effect.Enfeeble, TargetType.Both, 0, ValueType.ReplacedPower),
                    description: "Replace an ally and lower the power of allied and enemy cards on affected tiles by the replaced ally's power."),
        () => new("Valron", 2, 3,
                    [new(-1, -1), new(-1, 1), new(1, -1), new(1, 1)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 2, ValueType.EachAllyEnfeebled),
        ...
        () => new("Bahba Velamyu", 1, 2,
                    ...
                    destroyed: new(Effect.Enfeeble, TargetType.Enemy, 1),
                    description: "When destroyed, lower the power of enemy cards on affected tiles by 1."),
        () => new("Rictus", 1, 2,
                    [new(0, -1), new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 1, ValueType.EachEnfeebled),
        ...
        () => new("Ironclad", 3, 1,
                    [new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 3, ValueType.EachEnemyEnhanced),
        ...
        () => new("Red XIII", 1, 3,
                    ...
                    enfeebled: new(Effect.Enfeeble, TargetType.Enemy, 2),
                    legendary: true,
                    description: "When first enfabled, lower the power of enemy cards on affected tiles by 2."),
        () => new("Yuffie", -1, 1,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    [new(-1, -1), new(-1, 0), new(-1, 1), new(0, -1), new(0, 1), new(1, -1), new(1, 0), new(1, 1)],
                    played: new(Effect.Enfeeble, TargetType.Both, 0, ValueType.ReplacedPower),
        ...
        () => new("Cait Sith", 1, 1,
                    [new(0, -1), new(0, 1), new(1, 0)],
                    played: new(Effect.AddCard, TargetType.Self, (int)CardAdds.Moogle),
                    legendary: true,
                    description: "When played, add Moogle to your hand."),
        () => new("Cid", 1, 2,
                    [new(-2, 0), new(0, 1)],
                    played: new(Effect.AddCard, TargetType.Self, (int)CardAdds.TinyBronco),
                    legendary: true,
                    description: "When played, add The Tiny Bronco to your hand."),
        () => new("Vincent", 1, 2,
                    [new(-1, 0), new(0, 1), new(1, 0)],
                    destroyed: new(Effect.AddCard, TargetType.Self, (int)CardAdds.GalianBeast),
                    legendary: true,
                    description: "When destroyed, add Galian Beast to your hand."),
        () => new("Ifrit", 3, 5,
                    [new(-1, 0), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 2, ValueType.EachAllyEnhanced),
                    legendary: true,
                    description: "Raise power by 2 for each other enhanced ally card."),
        () => new("Shiva", 2, 4,
                    played: new(Effect.SpawnCards, TargetType.Self, (int)CardSpawns.DiamondDust),
                    legendary: true,
        ...
        () => new("Kujata", 3, 6,
                    [new(-1, 1), new(0, -1), new(1, 1)],
                    [new(-1, 1), new(0, -1), new(1, 1)],
                    enhanced: new(Effect.Enfeeble, TargetType.Enemy, 5),
                    legendary: true,
                    description: "When first enhanced, lower the power of enemy cards on affected tiles by 5."),
        () => new("Odin", 2, 3,
                    [new(-1, -1), new(-1, 1), new(1, -1), new(1, 1)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 2, ValueType.EachEnemyEnhanced),
                    legendary: true,
                    description: "Raise power by 2 for each enhanced enemy card."),
        () => new("Phoenix", 3, 4,
                    [new(-1, -1), new(-1, 1), new(1, -1), new(1, 1)],
                    [new(-1, -1), new(-1, 1), new(1, -1), new(1, 1)],
                    destroyed: new(Effect.Enhance, TargetType.Ally, 5),
                    legendary: true,
        ...
        () => new("Gilgamesh", -1, 3,
                    ...
                    played: new(Effect.Enhance, TargetType.Both, 0, ValueType.ReplacedPower),
                    legendary: true,
        ...
        () => new("Chocobo & Moogle", 1, 1,
                    [new(-1, 0), new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 1, ValueType.EachAllyEnhanced),
                    legendary: true,
        ...
        () => new("Posh Chocobo", 1, 2,
                    [new(0, -1), new(0, 1)],
                    laneWon: new(Effect.AddScore, TargetType.Self, 3),
                    legendary: true,
                    description: "When you win the lane, receive a score bonus of 3."),
        () => new("Moogle Trio", 2, 1,
                    [new(-1, 1), new(1, 1)],
                    played: new(Effect.AddCard, TargetType.Self, (int)CardAdds.MooglePair),
                    legendary: true,
        ...
        () => new("Materia Guardian", 3, 5,
                    ...
                    enfeebled: new(Effect.Enfeeble, TargetType.Enemy, 6),
                    legendary: true,
        ...
        () => new("Dyne", 3, 4,
                    ...
                    [new(-2, 1), new(-1, 2), new(1, 2), new(2, 1)],
                    played: new(Effect.Enfeeble, TargetType.Both, 5),
                    legendary: true,
        ...
        () => new("Specimen H1024", 3, 6,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    [new(-2, -2), new(-2, 0), new(-2, 2), new(0, -2), new(0, 2), new(2, -2), new(2, 0), new(2, 2)],
                    played: new(Effect.Enhance, TargetType.Both, 3),
                    destroyed: new(Effect.Enfeeble, TargetType.Both, 3),
                    legendary: true,
        ...
        () => new("Crimson Mare Mk. II", 3, 5,
                    [new(-1, 0), new(-1, 1), new(1, 0), new(1, 1)],
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    enfeebled: new(Effect.Enfeeble, TargetType.Both, 5),
                    legendary: true,
                    description: "When first enfabled, lower the power of allied and enemy cards on affected tiles by 5."),
        () => new("Gi Nattak", -1, 1,
                    [new(-1, 0), new(1, 0)],
                    [new(-1, 0), new(1, 0)],
                    played: new(Effect.Enhance, TargetType.Ally, 0, ValueType.ReplacedPower),
        ...
        () => new("Don Corneo & Abzu", 2, 4,
                    played: new(Effect.AddCard, TargetType.Self, (int)CardAdds.CorneoPair),
                    legendary: true,
        ...
        () => new("Demon Gate", 3, 5,
                    ...
                    [new(-1, -1), new(-1, 1), new(0, -1), new(0, 1), new(1, -1), new(1, 1)],
                    destroyed: new(Effect.Enfeeble, TargetType.Enemy, 9),
                    legendary: true,
        ...
        () => new("Elena", 1, 2,
                    [new(0, 1)],
                    [new(0, 1)],
                    enhanced: new(Effect.Enfeeble, TargetType.Both, 99),
                    legendary: true,
        ...
        () => new("Roche", 2, 6,
                    ...
                    played: new(Effect.Enfeeble, TargetType.Ally, 1),
                    legendary: true,
                    description: "When played, lower the power of allied cards on affected tiles by 1."),
        () => new("J-Squad", 3, 2,
                    played: new(Effect.SpawnCards, TargetType.Self, (int)CardSpawns.HypeJohnnys),
                    legendary: true,
        ...
        () => new("Space Ranger", 1, 2,
                    ...
                    inPlay: new(Effect.Enhance, TargetType.Self, 1, ValueType.EachEnemyEnhanced),
                    legendary: true,
        ...
        () => new("Emerald Witch", 2, 2,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    [new(-2, 0), new(-1, -1), new(-1, 1), new(0, -2), new(0, 2), new(1, -1), new(1, 1), new(2, 0)],
                    played: new(Effect.Enhance, TargetType.Both, 2),
                    destroyed: new(Effect.Enfeeble, TargetType.Both, 2),
                    legendary: true,
        ...
        () => new("Shadowblood Queen", 3, 3,
                    [new(-1, 0), new(-1, 1), new(1, 0), new(1, 1)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 3, ValueType.EachEnfeebled),
                    legendary: true,
    ...
    private static readonly Func<Card>[][] minions = [
        ...
        [() => new("Grangalan Junior", 2, 2,
                    [new(-1, -1), new(-1, 1), new(1, -1), new(1, 1)],
                    played: new(Effect.AddCard, TargetType.Self, (int)CardAdds.BabyGrangalan),
                    description: "When played, add Baby Grangalan to your hand.")],
        [() => new("Baby Grangalan", 1, 1,
                    [new(-1, -1), new(-1, 0), new(-1, 1), new(0, -1), new(0, 1), new(1, -1), new(1, 0), new(1, 1)],
                    [new(-1, -1), new(-1, 0), new(-1, 1), new(0, -1), new(0, 1), new(1, -1), new(1, 0), new(1, 1)],
                    destroyed: new(Effect.Enfeeble, TargetType.Both, 5),
    ...
    private static readonly Func<Card>[][] spawns = [
        ...
        [() => new("Hype Johnnys I", 0, 3,
         ...
         () => new("Hype Johnnys III", 0, 1,
                    abilityPositions: [new(-1, -1), new(-1, 0), new(-1, 1), new(0, -1), new(0, 1), new(1, -1), new(1, 0), new(1, 1)],
                    played: new(Effect.Enhance, TargetType.Both, 4),
                    destroyed: new(Effect.Enfeeble, TargetType.Both, 4),
                    legendary: true,
