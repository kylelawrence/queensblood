...
public static class Cards
{
    ...
    private static readonly Func<Card>[] cards = [
        ...
        () => new("Mandragora", 1, 1,
                    [new(0, 1), new(1, 0)],
                    played: new(Effect.AddCard, TargetType.Self, 0),
        ...
        () => new("Heatseeker", 1, 1,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    destroyed: new(Effect.AddCard, TargetType.Self, 1),
        ...
        () => new("Grangalan", 3, 3,
                    ...
                    played: new(Effect.AddCard, TargetType.Self, 2),
                    description: "When played, add Grangalan Junior to your hand."),
        () => new("Amalgam", 1, 1,
                    [new(0, -1), new(0, 1)],
                    destroyed: new(Effect.AddCard, TargetType.Self, 3),
        ...
        () => new("Cait Sith", 1, 1,
                    [new(0, -1), new(0, 1), new(1, 0)],
                    played: new(Effect.AddCard, TargetType.Self, 4),
                    legendary: true,
                    description: "When played, add Moogle to your hand."),
        () => new("Cid", 1, 2,
                    [new(-2, 0), new(0, 1)],
                    played: new(Effect.AddCard, TargetType.Self, 5),
                    legendary: true,
                    description: "When played, add The Tiny Bronco to your hand."),
        () => new("Vincent", 1, 2,
                    [new(-1, 0), new(0, 1), new(1, 0)],
                    destroyed: new(Effect.AddCard, TargetType.Self, 6),
                    legendary: true,
        ...
        () => new("Shiva", 2, 4, 
                    played: new(Effect.SpawnCards, TargetType.Self, 0),
                    legendary: true,
        ...
        () => new("Bahamut Arisen", 3, 4,
                    played: new(Effect.SpawnCards, TargetType.Self, 1),
                    legendary: true,
        ...
        () => new("Moogle Trio", 2, 1,
                    [new(-1, 1), new(1, 1)],
                    played: new(Effect.AddCard, TargetType.Self, 7),
                    legendary: true,
        ...
        () => new("Don Corneo & Abzu", 2, 4,
                    played: new(Effect.AddCard, TargetType.Self, 8),
                    legendary: true,
        ...
        () => new("J-Squad", 3, 2,
                    played: new(Effect.SpawnCards, TargetType.Self, 2),
                    legendary: true,
        ...
        () => new("Ultimate Party Animal", 1, 1,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    gameEnd: new(Effect.PartyAnimal, TargetType.Self),
                    legendary: true,
