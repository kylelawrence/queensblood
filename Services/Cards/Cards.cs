...
public static class Cards
{
    ...
    private static readonly Func<Card>[] cards = [
        ...
        () => new("Mu", 2, 1,
                    [new(-1, 1), new(0, 1)],
                    [new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Ally, 1),
        ...
        () => new("Crystalline Crab", 1, 1,
                    ...
                    [new(-1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Ally, 2),
        ...
        () => new("Shoalopod", 2, 1,
                    ...
                    [new(-1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Ally, 4),
        ...
        () => new("Chimera", 2, 4,
                    [new(-1, 0), new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 2, ValueType.Enfeebled, TargetType.Enemy),
        ...
        () => new("Valron", 2, 3,
                    [new(-1, -1), new(-1, 1), new(1, -1), new(1, 1)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 2, ValueType.Enfeebled, TargetType.Ally),
        ...
        () => new("Rictus", 1, 2,
                    [new(0, -1), new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 1, ValueType.Enfeebled, TargetType.Both),
        ...
        () => new("Ironclad", 3, 1,
                    [new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 3, ValueType.Enhanced, TargetType.Enemy),
        ...
        () => new("Ifrit", 3, 5,
                    [new(-1, 0), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 2, ValueType.Enhanced, TargetType.Ally),
                    legendary: true,
        ...
        () => new("Odin", 2, 3,
                    [new(-1, -1), new(-1, 1), new(1, -1), new(1, 1)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 2, ValueType.Enhanced, TargetType.Enemy),
                    legendary: true,
        ...
        () => new("Leviathan", 2, 4,
                    ...
                    [new(-2, -2), new(-2, 0), new(-2, 2), new(0, -2), new(0, 2), new(2, -2), new(2, 0), new(2, 2)],
                    inPlay: new(Effect.Enfeeble, TargetType.Enemy, 3),
                    legendary: true,
                    description: "Lower the power of enemy cards on affected tiles by 3 while this card is in play.",
                    imageOffsets: new(YOffset: -10)),
        () => new("Alexander", 3, 4,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 3, ValueType.Enfeebled, TargetType.Ally),
                    legendary: true,
        ...
        () => new("Chocobo & Moogle", 1, 1,
                    [new(-1, 0), new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 1, ValueType.Enhanced, TargetType.Ally),
                    legendary: true,
        ...
        () => new("Specimen H1024", 3, 6,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    [new(-2, -2), new(-2, 0), new(-2, 2), new(0, -2), new(0, 2), new(2, -2), new(2, 0), new(2, 2)],
                    inPlay: new(Effect.Enhance, TargetType.Both, 3),
                    legendary: true,
        ...
        () => new("Space Ranger", 1, 2,
                    ...
                    inPlay: new(Effect.Enhance, TargetType.Self, 1, ValueType.Enhanced, TargetType.Enemy),
                    legendary: true,
        ...
        () => new("Dio", 3, 4,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 1, ValueType.Enhanced, TargetType.Both),
                    legendary: true,
        ...
        () => new("Emerald Witch", 2, 2,
                    [new(-1, 0), new(0, -1), new(0, 1), new(1, 0)],
                    [new(-2, 0), new(-1, -1), new(-1, 1), new(0, -2), new(0, 2), new(1, -1), new(1, 1), new(2, 0)],
                    inPlay: new(Effect.Enhance, TargetType.Both, 2),
                    legendary: true,
        ...
        () => new("Shadowblood Queen", 3, 3,
                    [new(-1, 0), new(-1, 1), new(1, 0), new(1, 1)],
                    inPlay: new(Effect.Enhance, TargetType.Self, 3, ValueType.Enfeebled, TargetType.Both),
                    legendary: true,
    ...
    private static readonly Func<Card>[][] minions = [
        ...
        [() => new("Resurrected Amalgam", 1, 2,
                    [new(-1, 0), new(1, 0)],
                    [new(-1, 0), new(1, 0)],
                    inPlay: new(Effect.Enfeeble, TargetType.Both, 2),
    ...
    private static readonly Func<Card>[][] spawns = [
        ...
        [() => new("Hype Johnnys I", 0, 3,
         ...
         () => new("Hype Johnnys III", 0, 1,
                    abilityPositions: [new(-1, -1), new(-1, 0), new(-1, 1), new(0, -1), new(0, 1), new(1, -1), new(1, 0), new(1, 1)],
                    inPlay: new(Effect.Enhance, TargetType.Both, 4),
                    legendary: true,
